    ...
    static func seed(reference: Date = Date()) -> [NewsEvent] {
        ...
        return [
            ...
            NewsEvent(
                ...
                body: "Fuerzas federales y provinciales realizaron 14 allanamientos en distintos barrios del sur de la ciudad durante la madrugada. El operativo, que contó con más de 200 efectivos, dejó seis detenidos vinculados a una banda que operaba en la zona desde fines de 2024. Entre el material secuestrado figuran tres armas largas, dos vehículos, casi un kilo de cocaína y cinco millones de pesos en efectivo. La fiscalía especializada en narcocriminalidad pidió la indagatoria para mañana.",
                province: .santaFe,
